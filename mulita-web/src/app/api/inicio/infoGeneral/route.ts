...
export async function PATCH(req: NextRequest) {
  ...
  let imagen_url: string | File | null = formData.get("imagen") as string | File | null;

  // Obtener infoGeneral actual
